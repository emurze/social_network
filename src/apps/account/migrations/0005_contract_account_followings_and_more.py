...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='account',
            name='followings',
            field=models.ManyToManyField(related_name='followers', through='account.Contract', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddIndex(
            model_name='contract',
            index=models.Index(fields=['-created'], name='account_con_created_8c552f_idx'),
        ),
    ]
